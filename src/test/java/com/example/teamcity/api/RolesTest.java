...
import static com.example.teamcity.api.enums.RoleType.PROJECT_ADMIN;
import static com.example.teamcity.api.enums.RoleType.SYSTEM_ADMIN;
...
public class RolesTest extends BaseApiTest {
    ...
    public void systemAdminShouldHaveRightsToCreateProject() {
        ...
        testData.getUser().setRoles(TestDataGenerator.generateRoles(SYSTEM_ADMIN, "g"));
    ...
    public void projectAdminShouldHaveRightsToCreateBuildConfigToHisProject() {
        ...
        testData.getUser().setRoles(TestDataGenerator.generateRoles(PROJECT_ADMIN, "p:" + testData.getProject().getId()));
